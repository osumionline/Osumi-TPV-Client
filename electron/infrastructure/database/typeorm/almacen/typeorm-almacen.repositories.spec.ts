...
import prepareAlmacenRepositoriesFixture from '@infrastructure/database/typeorm/almacen/typeorm-almacen.repositories.fixture';
...
describe('TypeORM Almacén repositories', (): void => {
  beforeEach(async (): Promise<void> => {
    ...
    await prepareAlmacenRepositoriesFixture(dataSource);

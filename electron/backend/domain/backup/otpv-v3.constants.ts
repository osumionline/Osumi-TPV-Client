...
export const OTPV_V3_CRYPTO_SUITE = 'otpv3-scrypt-aes-256-gcm' as const;
export const OTPV_V3_KDF_ALGORITHM = 'scrypt' as const;
...
export const OTPV_V3_SCRYPT_COST = 32_768 as const;
export const OTPV_V3_SCRYPT_BLOCK_SIZE = 8 as const;
export const OTPV_V3_SCRYPT_PARALLELIZATION = 3 as const;
export const OTPV_V3_SCRYPT_MAXMEM_BYTES: number = 64 * 1024 * 1024;

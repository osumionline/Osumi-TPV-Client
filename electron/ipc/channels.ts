const IPC_CHANNELS = {
  ...
  almacenSearchCaducidades: 'almacen:search-caducidades',
  almacenGetCaducidadFilterOptions: 'almacen:get-caducidad-filter-options',
  ...
  clientesCreateFacturaBorrador: 'clientes:create-factura-borrador',
  ...
  clientesCreateFacturaDesdeVenta: 'clientes:create-factura-desde-venta',
  ...
  clienteFacturaPreviewGetDocumento: 'cliente-factura-preview:get-documento',
  clienteFacturaPreviewEmitir: 'cliente-factura-preview:emitir',
  clientesGetFacturaVentas: 'clientes:get-factura-ventas',

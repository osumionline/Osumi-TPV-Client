const IPC_CHANNELS = {
  ...
  comprasGetPedidoLineas: 'compras:get-pedido-lineas',
  ...
  comprasRecepcionarPedido: 'compras:recepcionar-pedido',
  comprasResolvePedidoArticulo: 'compras:resolve-pedido-articulo',
  ...
  comprasOpenPedidoPdf: 'compras:open-pedido-pdf',
  ...
  proveedoresGetById: 'proveedores:get-by-id',
  ...
  tiposPagoGetEstadisticas: 'tipos-pago:get-estadisticas',
  tiposPagoCreate: 'tipos-pago:create',
  tiposPagoUpdate: 'tipos-pago:update',
  tiposPagoReorder: 'tipos-pago:reorder',
  ...
  cajaOpenInformeVentas: 'caja:open-informe-ventas',

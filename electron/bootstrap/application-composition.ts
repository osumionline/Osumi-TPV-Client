...
import ElectronCaducidadReportWindow from '@infrastructure/electron/almacen/electron-caducidad-report-window';
...
import registerMarcasIpc from '@ipc/compras/register-marcas-ipc';
import registerProveedoresIpc from '@ipc/compras/register-proveedores-ipc';
import registerCajaIpc from '@ipc/configuration/register-caja-ipc';
...
export default function createApplicationComposition(
  ...
  const informeDetalladoRepository: InformeDetalladoRepository =
    new TypeOrmInformeDetalladoRepository(operationalDatabase);

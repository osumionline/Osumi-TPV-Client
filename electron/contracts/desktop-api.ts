...
import type MarcasApi from '@desktop-contracts/compras/marcas/marcas-api.interface';
import type ProveedoresApi from '@desktop-contracts/compras/proveedores/proveedores-api.interface';

export interface ArticuloCodigoBarrasInterface {
  readonly id: number;
...
export interface ArticuloFotoInterface {
  readonly id: number;
  readonly publicId: string;
...
export interface ArticuloInterface {
  ...
  readonly codigosBarras: readonly ArticuloCodigoBarrasInterface[];
  readonly fotos: readonly ArticuloFotoInterface[];
}
